...
REPO_CONFIG="\
LAYER@https://github.com/MontaVista-OpenSourceTechnology/poky.git;branch=wrynose;layer=meta \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/poky.git;branch=wrynose;layer=meta-poky \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/poky.git;branch=wrynose;layer=meta-yocto-bsp \
...
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-raspberrypi.git;branch=wrynose \
